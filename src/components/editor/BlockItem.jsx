  ...
  return (
    <div
      ...
      className={`border rounded-lg overflow-hidden transition-colors ${
        isActive ? 'border-[#2a2a2a] bg-[#161616]' : 'border-[#1a1a1a] bg-[#111] hover:border-[#222]'
      }`}
    >
      {/* Header row */}
      <div
      ...
      >
        ...
        <div
          ...
          className="cursor-grab active:cursor-grabbing text-[#2a2a2a] hover:text-[#555] px-0.5 transition-colors"
        ...
        <button
          ...
          className="text-[#333] hover:text-[#888] text-xs transition-colors px-1"
          title="Duplicate"
        >
          ⧉
        </button>
        ...
        <button
          ...
          className="text-[#333] hover:text-[#ff5757] text-base leading-none transition-colors"
          title="Remove block"
        >
          ×
        </button>

        <span className={`text-[#333] text-xs transition-transform duration-200 ${isActive ? 'rotate-180' : ''}`}>▾</span>
      </div>
