    ...
    <nav className="sticky top-0 z-50 bg-[#f5f4ef]/95 backdrop-blur border-b border-gray-200">
      <div className="max-w-7xl mx-auto px-6 flex items-center justify-between h-16">
        ...
        <div className="flex items-center gap-3">
          ...
          >
            <svg className="w-5 h-5 md:h-4 md:w-4" fill="currentColor" viewBox="0 0 24 24">
            ...
            <span className="hidden md:flex"> Star on Github</span>
          </a>
          <button
            onClick={onSignIn}
            className="text-[12px]! md:text-sm! text-white! bg-black! rounded-[8px] px-4 py-2 hover:bg-gray-800 transition font-medium"
          >
            Try ReadmeForge
          </button>
        </div>
