...
export default function UsageBlock({ content, onChange }) {
  return (
    <div className="space-y-4">
      ...
      <div className="space-y-1.5">
        <label className="block text-[10px] text-gray-500 font-mono uppercase tracking-wider overflow-hidden">
          Code
        </label>
        <div className="relative">
          ...
          <div className="absolute left-0 top-0 bottom-0 w-8 bg-gray-100 border-r! border-gray-200! scale-97 relativ
                          flex flex-col items-end pr-2 pt-2 text-[10px] font-mono text-gray-300! select-none pointer-events-none bottom-1">
